# 10. Product Logic & Burnout Monitoring
> **File:** `10-product-logic-burnout.md`  
> **Status:** `STABLE` | **Domain:** `Reliability Tracking & Volunteer Health`
...
- **CANCELLED (After Lockout):** Negative impact (Late cancellation penalty).
- **ABSENT:** High negative impact (No-show penalty).
...
- **Historical Context:** Even if a volunteer withdraws, the `CANCELLED` record remains linked to their profile. 
